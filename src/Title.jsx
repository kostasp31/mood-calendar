  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 32 32"
      >
        <title xmlns="">calendar-edit-32</title>
        <g fill="none">
          <path
            fill="url(#SVGU1eE1b5T)"
            d="m29 20l-9 9H7.5A4.5 4.5 0 0 1 3 24.5V10l13-1l13 1z"
          />
          <path
            fill="url(#SVGkFtYpesI)"
            d="m29 20l-9 9H7.5A4.5 4.5 0 0 1 3 24.5V10l13-1l13 1z"
          />
          <path
            fill="url(#SVGJ3aOCI1z)"
            fillOpacity=".3"
            d="m29 20l-9 9H7.5A4.5 4.5 0 0 1 3 24.5V10l13-1l13 1z"
          />
          <g filter="url(#SVGzEwpPcLX)">
            <path
              fill="url(#SVGkHpQsC8g)"
