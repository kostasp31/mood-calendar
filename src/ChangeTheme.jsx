export default function ChangeTheme({ theme, setTheme }) {
  ...
  return (
    <div onClick={changeTheme} style={{ position: 'absolute', top: '32px', right: '32px', cursor: 'pointer', /*border: `2px solid ${iconColor}`,*/ padding: '5px', paddingBottom: '0px', borderRadius: '100%' }}>
      {theme === 'light' ?
